app.controller('SupplyMatchingCtrl', ['$scope', '$state', '$filter', '$rootScope', '$q', '$stateParams', '$location', '$http', 'ngDialog', 'PagerExtends', 'layerAlert', 'serverUrls', 'PcService',
	function($scope, $state, $filter, $rootScope, $q, $stateParams, $location, $http, ngDialog, PagerExtends, layerAlert, serverUrls, PcService) {
		...
		$scope.fetchData = function() {
			$scope.listBusyPromise = $http({
				...
				method: "get",
				url: serverUrls.getsingleinformation + "?singleInformationType=" + 7
