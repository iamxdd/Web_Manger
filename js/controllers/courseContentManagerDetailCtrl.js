app.controller('courseContentManagerDetailCtrl', ['$scope', '$stateParams', '$state', '$q', '$rootScope', '$http', 'ngDialog', 'PagerExtends', 'layerAlert', '$filter', 'PcService', 'serverUrls',
	function($scope, $stateParams, $state, $q, $rootScope, $http, ngDialog, PagerExtends, layerAlert, $filter, PcService, serverUrls) {
		...
		var getnewsarticledetails = function(id) {
			$scope.listBusyPromise = $http({
				...
				method: "get",
				url: serverUrls.trainTraining + "?id=" + id
